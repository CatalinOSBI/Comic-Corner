...
export const ModalProvider = ({ children }) => {
  ...
  const dotsIcon = <svg anch className='dotsIcon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 512"><path fill="#74a3eb" d="M64 360a56 56 0 1 0 0 112 56 56 0 1 0 0-112zm0-160a56 56 0 1 0 0 112 56 56 0 1 0 0-112zM120 96A56 56 0 1 0 8 96a56 56 0 1 0 112 0z" /></svg>
        ...
        <div className='modalFolder' >
          ...
          <div onClick={(e) => handleShowDotsMenu(e, folder.id)} className='dotsWrapper'>
            ...
            {showDotsMenu && activeFolderId === folder.id &&
              //DotsMenu
              <div className='dotsMenu' onMouseLeave={(e) => handleHideDotsMenu(e, folder)} onMouseEnter={(e) => handleKeepMenuVisible(e, folder.id)}>
                <ul className='dotsMenuList' style={{ listStyleType: 'none' }}>
                  <li onClick={(e) => handleRenameFolder(e, folder.id , "Cookie")}> {penIcon} Rename </li>
