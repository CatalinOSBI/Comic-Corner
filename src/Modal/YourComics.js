    ...
    <>
      ...
      <div className='modalFolderWrapper'>
        <div className='modalFolder' onMouseLeave={()=> setShowNameFolder(false)}  >
          ...
          {showNameFolder ? (
            <>
              <div style={{ paddingTop: '16px', display: 'flex', justifyContent: 'center', alignItems: 'cener', flexDirection: 'column', opacity: dynamicOpacity, transition:'all .218s'}}>
                <input style={{ width: '98.2%' }} id='folderName' name='folderName' placeholder='Folder Name' type='text' ref={folderNameRef} />
